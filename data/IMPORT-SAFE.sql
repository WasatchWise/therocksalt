...
-- Safe version - skips duplicates
-- ========================================

-- Step 1: Import Genres (skip if exists)
-- ========================================
...
-- Step 2: Import Bands (skip if exists)
-- ========================================

INSERT INTO public.bands (slug, name, hometown, tier, description, bio) VALUES
('chelsea-grin', 'Chelsea Grin', 'Salt Lake City, UT', 'platinum',
 'Deathcore metal band signed to major labels, one of Utah''s most globally recognized metal acts.',
...
('cult-leader', 'Cult Leader', 'Salt Lake City, UT', 'gold',
...
('eagle-twin', 'Eagle Twin', 'Salt Lake City, UT', 'gold',
...
('fictionist', 'Fictionist', 'Provo, UT', 'silver',
...
('form-of-rocket', 'Form of Rocket', 'Salt Lake City, UT', 'silver',
...
('iceburn', 'Iceburn', 'Salt Lake City, UT', 'hall-of-fame',
...
('imagine-dragons', 'Imagine Dragons', 'Las Vegas, NV (Utah roots)', 'platinum',
...
('insight', 'Insight', 'Salt Lake City, UT', 'hall-of-fame',
...
('idkhow', 'I Don''t Know How But They Found Me', 'Salt Lake City, UT', 'platinum',
...
('the-national-parks', 'The National Parks', 'Provo, UT', 'gold',
...
('neon-trees', 'Neon Trees', 'Provo, UT', 'hall-of-fame',
...
('the-osmonds', 'The Osmonds', 'Ogden, UT', 'hall-of-fame',
...
('red-bennies', 'Red Bennies', 'Salt Lake City, UT', 'silver',
...
('royal-bliss', 'Royal Bliss', 'Salt Lake City, UT', 'gold',
...
('subrosa', 'SubRosa', 'Salt Lake City, UT', 'gold',
...
('swim-herschel-swim', 'Swim Herschel Swim', 'Salt Lake City, UT', 'hall-of-fame',
...
('talia-keys', 'Talia Keys', 'Salt Lake City, UT', 'silver',
...
('the-used', 'The Used', 'Orem, UT', 'hall-of-fame',
...
('victims-willing', 'Victims Willing', 'Salt Lake City, UT', 'hall-of-fame',
...
('clear', 'Clear', 'Salt Lake City, UT', 'gold',
...
('the-brobecks', 'The Brobecks', 'Salt Lake City, UT', 'silver',
...
('gaza', 'Gaza', 'Salt Lake City, UT', 'silver',
...
('the-backseat-lovers', 'The Backseat Lovers', 'Provo, UT', 'platinum',
...
('worlds-worst', 'Worlds Worst', 'Salt Lake City, UT', 'bronze',
 'Punk group with national buzz.', NULL),

('fancy-ladz', 'Fancy Ladz', 'Salt Lake City, UT', 'bronze',
 'Popular local punk band.', NULL),

('american-humor', 'American Humor', 'Salt Lake City, UT', 'bronze',
 'Favorite local punk band.', NULL),

('spitting-teeth', 'Spitting Teeth', 'Salt Lake City, UT', 'silver',
 '1978 punk pioneers, hosted one of SLC''s first punk shows at University of Utah.', NULL),

('the-atheists', 'The Atheists', 'Salt Lake City, UT', 'bronze',
 'Late 1970s punk band.', NULL)
ON CONFLICT (slug) DO NOTHING;

-- Step 3: Import Venues (skip if exists)
-- ========================================
...
SELECT 'Bands imported:', COUNT(*) FROM public.bands;
SELECT 'Genres imported:', COUNT(*) FROM public.genres;
SELECT 'Venues imported:', COUNT(*) FROM public.venues;
